...
public class CircularQueueOp implements Queue{	
	
	private int size, front, rear;   
	private ArrayList<Integer> queue = new ArrayList<Integer>(); 
	  
	// Constructor 
	CircularQueueOp(int size) 
	{ 
	    this.size = size; 
	...
	/**
	 * Method to add data item into queue if queue is not full otherwise displays a message
	...
	{ 
	    ...
	    CircularQueueOp q = new CircularQueueOp(sc.nextInt()); 
	    boolean flag=true;
	    while(flag)
	    {
	    System.out.println("\nEnter your choice\n"+"1: Enqueue\n"+"2: Dequeue\n"+"3: IsEmpty\n"+"4: IsFull\n"+ "5: displayQueue\n"+"6: Exit");  
